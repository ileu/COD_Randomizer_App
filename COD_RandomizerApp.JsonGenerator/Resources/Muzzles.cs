...
namespace COD_Randomizer_App.JsonGenerator.Resources
{
    public static class Muzzles
    {
        ...
        {
            Factory.AddToGroup("Flash Guard", Id.MuzzleAssault, Id.MuzzleOden, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);
            Factory.AddToGroup("Tactical Suppressor", Id.MuzzleAssault, Id.MuzzleOden, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);
            Factory.AddToGroup("Breacher Device", Id.MuzzleAssault);
            Factory.AddToGroup("Muzzle Brake", Id.MuzzleAssault, Id.MuzzleOden, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);
            Factory.AddToGroup("Lightweight Suppressor", Id.MuzzleAssault, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);

            Factory.AddToGroup("Compensator", Id.MuzzleAssault, Id.MuzzleOden, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);
            Factory.AddToGroup("Monolithic Suppressor", Id.MuzzleAssault, Id.MuzzleOden, Id.MuzzleFAL, Id.MuzzleFR556, Id.MuzzleAK47MW);
