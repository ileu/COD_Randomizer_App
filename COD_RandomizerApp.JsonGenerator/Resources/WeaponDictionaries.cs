...
namespace COD_Randomizer_App.JsonGenerator.Resources
{
    public static class WeaponDictionaries
    {
       ...
       public static readonly Dictionary<string, Dictionary<string, Id>> dmr_dict = new Dictionary<string, Dictionary<string, Id>> { { "MK2 Carbine", mk2 }, { "EBR-14", ebr }, { "SKS", sks }, { "SP-R 208", spr }, { "Crossbow", armbrust }, { "Kar98K", kar } };
