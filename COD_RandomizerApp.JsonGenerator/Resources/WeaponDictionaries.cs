...
namespace COD_Randomizer_App.JsonGenerator.Resources
{
    public static class WeaponDictionaries
    {
        ...
        /*
        public static readonly Dictionary<string, Dictionary<string, int>> sturmgewehr_dict = new Dictionary<string, Dictionary<string, int>> { { "QBZ", qbz }, { "Fara", fara }, { "XM4", xm4 }, { "AK-47 Black ops", ak47_black }, { "Krig 6", krig }, { "FFAR", ffar }, { "Groza", groza }, { "Oden", oden }, { "FAL", fal }, { "FR 5.56", fr556 }, { "Scar", scar }, { "AS Val", asval }, { "AK 47 MW", ak47_mw }, { "CR 56 Amax", amax }, { "Kilo 141", kilo }, { "AN94", an94 }, { "M13", m13 }, { "Ram 7", ram7 }, { "Grau", grau }, { "M4A1", m4a1 }, { "C58", c58 } };
