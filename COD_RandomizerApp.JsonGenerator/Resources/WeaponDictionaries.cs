...
namespace COD_Randomizer_App.JsonGenerator.Resources
{
    public static class WeaponDictionaries
    {
        ...
        public static readonly Dictionary<string, Id> fr556 = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleFR556 }, { "Barrel", Id.BarrelFR556 }, { "Laser", Id.LaserMW }, { "Optic", Id.OpticMW },
            { "Stock", Id.StockFR556 }, { "Underbarrel", Id.UnderbarrelScar }, { "Ammunition", Id.MagazinFR556 }, { "Rear Grip", Id.RearGripAssault }, { "Perk", Id.PerksFR556 } };
        public static readonly Dictionary<string, Id> ak47_mw = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleAK47MW }, { "Barrel", Id.BarrelAK47MW }, { "Laser", Id.LaserMW }, { "Optic", Id.OpticAK47MW },
            { "Stock", Id.StockAK47MW }, { "Underbarrel", Id.UnderbarrelAK47MW }, { "Ammunition", Id.MagazinAK47MW }, { "Rear Grip", Id.RearGripAssault }, { "Perk", Id.PerksFR556 } }; //PerksFR556 == PerksAK47MW
        ...
        public static readonly Dictionary<string, Id> ak47_black = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleEast }, { "Barrel", Id.BarrelAk47 }, { "Laser", Id.LaserEast }, { "Optic", Id.OpticEast },
            { "Stock", Id.StockAK47 }, { "Underbarrel", Id.UnderbarrelEast }, { "Ammunition", Id.MagazinEast }, { "Rear Grip", Id.RearGripEast } };
        public static readonly Dictionary<string, Id> krig = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleWest }, { "Barrel", Id.BarrelKrig }, { "Laser", Id.LaserWest }, { "Optic", Id.OpticWest },
            { "Stock", Id.StockKrig }, { "Underbarrel", Id.UnderbarrelWest }, { "Ammunition", Id.MagazinWest }, { "Rear Grip", Id.RearGripWest } };
        public static readonly Dictionary<string, Id> ffar = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleWest }, { "Barrel", Id.BarrelFFAR }, { "Laser", Id.LaserWest }, { "Optic", Id.OpticWest },
            { "Stock", Id.StockFFAR }, { "Underbarrel", Id.UnderbarrelWest }, { "Ammunition", Id.MagazineFFAR }, { "Rear Grip", Id.RearGripWest } };
        public static readonly Dictionary<string, Id> fara = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleEast5 }, { "Barrel", Id.BarrelFara }, { "Laser", Id.LaserWest }, { "Optic", Id.OpticWest },
            { "Stock", Id.StockFara }, { "Underbarrel", Id.UnderbarrelEast }, { "Ammunition", Id.MagazinEast}, { "Rear Grip", Id.RearGripEast } };
        public static readonly Dictionary<string, Id> qbz = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleWest }, { "Barrel", Id.BarrelQBZ }, { "Laser", Id.LaserWest }, { "Optic", Id.OpticWest },
        ...
        public static readonly Dictionary<string, Id> c58 = new Dictionary<string, Id> { { "Muzzle", Id.MuzzleWest }, { "Barrel", Id.BarrelC58 }, { "Laser", Id.LaserWest }, { "Optic", Id.OpticWest },
        ...
        public static readonly Dictionary<string, int> ak74 = new Dictionary<string, int> { { "Muzzle", 6 }, { "Barrel", 6 }, { "Laser", 6 }, { "Optic", 12 }, { "Stock", 6 }, { "Underbarrel", 6 }, { "Ammunition", 6 }, { "Rear Grip", 6 } };
        ...
        /*
        public static readonly Dictionary<string, Dictionary<string, int>> sturmgewehr_dict = new Dictionary<string, Dictionary<string, int>> { { "QBZ", qbz }, { "Fara", fara }, { "XM4", xm4 }, { "AK-47 Black ops", ak47_black }, { "Krig 6", krig }, { "FFAR", ffar }, { "Groza", groza }, { "Oden", oden }, { "FAL", fal }, { "FR 5.56", fr556 }, { "FN SCAR 17", scar }, { "AS Val", asval }, { "AK 47 MW", ak47_mw }, { "CR 56 Amax", amax }, { "Kilo 141", kilo }, { "AN94", an94 }, { "M13", m13 }, { "Ram 7", ram7 }, { "Grau", grau }, { "M4A1", m4a1 }, { "C58", c58 } };
        public static readonly Dictionary<string, Dictionary<string, int>> mp_dict = new Dictionary<string, Dictionary<string, int>> { { "Mac 10", mac }, { "Milano", milano }, { "LC-10", lc10 }, { "KSP", ksp }, { "AK 74u", ak74 }, { "Ppsh", ppsh }, { "MP5 Black ops", mp5_black }, { "Bullfrog", bullfrog }, { "Aug MW", aug_mw }, { "Striker", striker }, { "Fennek", fennek }, { "PP 19", pp19 }, { "MP7", mp7 }, { " P90", p90 }, { "MP5 MW", mp5_mw }, { "Uzi", uzi }, { "Iso", iso } };
        ...
        public static readonly Dictionary<string, Dictionary<string, int>> taktikgewehr_dict = new Dictionary<string, Dictionary<string, int>> { { "DMR 14", dmr14 }, { "Type 63", type63 }, { "M16", m16 }, { "Aug Black ops", aug_black }, { "CARV.2", carv } };
        public static readonly Dictionary<string, Dictionary<string, int>> dmr_dict = new Dictionary<string, Dictionary<string, int>> { { "MK 2", mk2 }, { "EBR 14", ebr }, { "SKS", sks }, { "SPR", spr }, { "Armbrust", armbrust }, { "Kar", kar } };
